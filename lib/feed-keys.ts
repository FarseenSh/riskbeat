...
export const FEED_KEYS = ["defiscan", "defipunkd", "philidor", "pharos", "defillama-hacks", "defisphere", "anticapture", "credora", "xerberus", "llamarisk", "gauntlet", "defisafety", "yo"] as const;
